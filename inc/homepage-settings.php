...
function rawlaw_home_default_content() {
	...
	return array(
		...
		'kyr'       => array(
			...
			'issues' => array(
				array( 'title' => __( 'I am going through a divorce', 'rawlaw' ), 'sub' => __( 'Family law · Maintenance · Custody', 'rawlaw' ), 'area' => 'family-law', 'details' => __( 'I need advice on divorce, maintenance, custody, or a related family matter.', 'rawlaw' ), 'image' => $asset_base . 'divorce-mediation.png', 'visual_title' => __( 'Family matter intake', 'rawlaw' ), 'visual_desc' => __( 'Turn maintenance, custody, separation or settlement questions into a structured legal request.', 'rawlaw' ) ),
				array( 'title' => __( 'I need bail for someone', 'rawlaw' ), 'sub' => __( 'Criminal law · Bail application', 'rawlaw' ), 'area' => 'criminal-law', 'details' => __( 'I need legal help for bail or an urgent criminal matter.', 'rawlaw' ), 'image' => $asset_base . 'bail-application.png', 'visual_title' => __( 'Urgent criminal help', 'rawlaw' ), 'visual_desc' => __( 'Capture urgency, court context and city so the matter can be understood quickly.', 'rawlaw' ) ),
				array( 'title' => __( 'My landlord is threatening eviction', 'rawlaw' ), 'sub' => __( 'Property · Tenancy rights', 'rawlaw' ), 'area' => 'civil-law', 'details' => __( 'My landlord is threatening eviction and I need to understand my tenancy rights.', 'rawlaw' ), 'image' => $asset_base . 'landlord-eviction-notice.png', 'visual_title' => __( 'Tenancy rights clarity', 'rawlaw' ), 'visual_desc' => __( 'Explain rent, notice, possession and landlord issues in a format advocates can assess.', 'rawlaw' ) ),
				array( 'title' => __( 'I received a legal notice', 'rawlaw' ), 'sub' => __( 'Civil law · Reply and next steps', 'rawlaw' ), 'area' => '', 'details' => __( 'I received a legal notice and need help understanding the reply and next steps.', 'rawlaw' ), 'image' => $asset_base . 'legal-notice.png', 'visual_title' => __( 'Notice reply planning', 'rawlaw' ), 'visual_desc' => __( 'Summarize deadlines, sender details and response needs before sharing documents after signup.', 'rawlaw' ) ),
				array( 'title' => __( 'I want to file a consumer complaint', 'rawlaw' ), 'sub' => __( 'Consumer protection · E-filing', 'rawlaw' ), 'area' => 'other', 'details' => __( 'I want to file a consumer complaint and need guidance on the process.', 'rawlaw' ), 'image' => $asset_base . 'consumer-complaint.png', 'visual_title' => __( 'Consumer dispute support', 'rawlaw' ), 'visual_desc' => __( 'Organize purchase details, complaint history and requested remedy for a stronger first brief.', 'rawlaw' ) ),
				array( 'title' => __( 'I need to register property', 'rawlaw' ), 'sub' => __( 'Property · Registration process', 'rawlaw' ), 'area' => 'civil-law', 'details' => __( 'I need help with property registration, documents, or next legal steps.', 'rawlaw' ), 'image' => $asset_base . 'property-registration.png', 'visual_title' => __( 'Property document review', 'rawlaw' ), 'visual_desc' => __( 'Clarify registry, title, stamp duty or document questions before moving to a consultation.', 'rawlaw' ) ),
			),
		),
		'news'      => array(
...
function rawlaw_homepage_settings_page() {
	...
	<div class="wrap rawlaw-home-settings">
		...
		<form method="post" action="options.php">
			<?php settings_fields( 'rawlaw_homepage_settings' ); ?>
				...
				<div class="rawlaw-home-layout">
					...
					<div class="rawlaw-home-main">
						<?php rawlaw_homepage_panel_open( 'rawlaw-panel-hero', __( 'Hero', 'rawlaw' ), __( 'Controls the first viewport marketing copy and secondary advocate prompt. Query form settings stay locked in code.', 'rawlaw' ) ); ?>
			...
			rawlaw_homepage_card_open( __( 'Advocate Prompt', 'rawlaw' ), __( 'Small secondary path below the hero action.', 'rawlaw' ) );
			...
			<?php rawlaw_homepage_panel_close(); ?>
						...
						<?php rawlaw_homepage_panel_open( 'rawlaw-panel-kyr', __( 'Know Your Rights', 'rawlaw' ), __( 'Issue cards and rotating right-side visuals. Query prefill/category mapping stays locked in code.', 'rawlaw' ) ); ?>
