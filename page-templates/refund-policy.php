			...
			<div class="legal-toc">
				...
				<nav>
					<ol class="legal-toc__list">
						...
						<li><a href="#rp-marketplace"><?php esc_html_e( '2. Marketplace Queries', 'rawlaw' ); ?></a></li>
						<li><a href="#rp-subscription"><?php esc_html_e( '3. Subscription Plans', 'rawlaw' ); ?></a></li>
						<li><a href="#rp-litigation"><?php esc_html_e( '4. Litigation Support Services', 'rawlaw' ); ?></a></li>
						<li><a href="#rp-eligibility"><?php esc_html_e( '5. Eligibility for Refund', 'rawlaw' ); ?></a></li>
						<li><a href="#rp-process"><?php esc_html_e( '6. Refund Process', 'rawlaw' ); ?></a></li>
						<li><a href="#rp-timeline"><?php esc_html_e( '7. Refund Timeline', 'rawlaw' ); ?></a></li>
						<li><a href="#rp-non-refundable"><?php esc_html_e( '8. Non-Refundable Items', 'rawlaw' ); ?></a></li>
						<li><a href="#rp-disputes"><?php esc_html_e( '9. Disputes', 'rawlaw' ); ?></a></li>
						<li><a href="#rp-contact"><?php esc_html_e( '10. Contact Us', 'rawlaw' ); ?></a></li>
					</ol>
				</nav>
			</div>
		</aside>
