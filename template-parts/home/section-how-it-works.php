...
$steps = array(
	array(
		...
		'desc'  => __( 'Use the hero wizard to describe the matter, city, urgency, and contact route.', 'rawlaw' ),
	...
	array(
		...
		'desc'  => __( 'The requirement is saved privately in WordPress with issue type, city, urgency, and details.', 'rawlaw' ),
