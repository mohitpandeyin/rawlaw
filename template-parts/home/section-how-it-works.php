...
$steps = array(
	array(
		'num'   => '1',
		'title' => __( 'Read or search your issue', 'rawlaw' ),
		'desc'  => __( 'Start with news, guides, services, or a plain-language legal query.', 'rawlaw' ),
	...
	array(
		'num'   => '2',
		'title' => __( 'Choose the next step', 'rawlaw' ),
		'desc'  => __( 'Browse lawyers, open a service page, or post a legal requirement.', 'rawlaw' ),
	...
	array(
		'num'   => '3',
		'title' => __( 'Compare with confidence', 'rawlaw' ),
		'desc'  => __( 'Check verification, city, practice areas, experience, fees, and responses.', 'rawlaw' ),
	...
	array(
		'num'   => '4',
		'title' => __( 'Consult and review', 'rawlaw' ),
		'desc'  => __( 'Book the consultation, track the matter, and leave a verified review.', 'rawlaw' ),
...
<section class="section section--alt section--how-it-works" aria-labelledby="hiw-heading" data-reveal>
	<div class="container">
		<header class="section__header section__header--centered">
			...
			<h2 id="hiw-heading" class="section__title"><?php esc_html_e( 'From legal news to legal action', 'rawlaw' ); ?></h2>
			<p class="section__sub"><?php esc_html_e( 'RawLaw keeps the journey clear: understand the issue, compare verified options, then move only when you are ready.', 'rawlaw' ); ?></p>
		</header>
		...
		<div class="how-it-works__cta">
			...
			<p class="how-it-works__cta-note"><?php esc_html_e( 'No registration needed to browse lawyers.', 'rawlaw' ); ?></p>
		</div>
	</div>
</section>
