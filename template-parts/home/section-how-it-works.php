...
$steps = array(
	array(
		'num'   => '1',
		'title' => __( 'Start With Your Query', 'rawlaw' ),
		'desc'  => __( 'Post your legal issue or begin by exploring lawyers based on your needs.', 'rawlaw' ),
	...
	array(
		'num'   => '2',
		'title' => __( 'See Lawyer Details', 'rawlaw' ),
		'desc'  => __( 'Review lawyer profiles, practice areas, years of experience and fee quotes.', 'rawlaw' ),
	...
	array(
		'num'   => '3',
		'title' => __( 'Check Orders & Drafts', 'rawlaw' ),
		'desc'  => __( 'Browse similar court orders they have appeared in and sample legal drafts they have prepared.', 'rawlaw' ),
	...
	array(
		'num'   => '4',
		'title' => __( 'Receive Bids & Choose', 'rawlaw' ),
		'desc'  => __( 'Get bids and proposals from multiple lawyers, compare fees and decide privately with clarity.', 'rawlaw' ),
