...
$steps = array(
	array(
		'num'   => '1',
		'title' => __( 'Post Your Legal Query', 'rawlaw' ),
		'desc'  => __( 'Describe your issue, location and the assistance you need.', 'rawlaw' ),
	...
	array(
		'num'   => '2',
		'title' => __( 'Receive Responses and Fee Quotes', 'rawlaw' ),
		'desc'  => __( 'Get replies, suggestions and professional fee proposals from interested advocates.', 'rawlaw' ),
	...
	array(
		'num'   => '3',
		'title' => __( 'Review and Compare Profiles', 'rawlaw' ),
		'desc'  => __( 'Check their experience, practice areas, court appearances, similar matters handled and professional portfolio. Compare the proposals and fees received.', 'rawlaw' ),
	...
	array(
		'num'   => '4',
		'title' => __( 'Communicate and Decide', 'rawlaw' ),
		'desc'  => __( 'Speak directly with the advocates, ask questions and engage the one you consider most suitable.', 'rawlaw' ),
