	...
	<div class="container">
		<header class="section__header">
			<div>
				...
				<p class="section__sub"><?php esc_html_e( 'Compare practice area, city, experience, and consultation action before sharing sensitive details.', 'rawlaw' ); ?></p>
			</div>
		...
		<div class="grid grid--showcase" data-reveal-stagger>
			...
			<div class="showcase-card">
				...
				<div class="showcase-card__cta">
					...
					<a class="btn btn--primary btn--sm" href="<?php the_permalink(); ?>#consult"><?php esc_html_e( 'Request Consult', 'rawlaw' ); ?></a>
				</div>
			</div>
			<?php endwhile; ?>
		</div>
